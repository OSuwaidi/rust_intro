...
fn add_generics<T>(x: T, y: T) -> T {
    x + y
} // this will give an error because you can't use the "+" operation on two or more generic types since the "Add" trait is not implemented for them
*/

// Therefore, we need to implement (define) the "Add" trait for the generic datatypes first:
